            ...
            <div className="bg-red-50 bg-opacity-90 p-8 rounded-lg shadow-lg w-full max-w-6xl mx-auto my-8 flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-4">
                    ...
                    <div className="items-center justify-between mt-4">
                        <a href="#" style={{ fontFamily: 'inria-serif' }} className="text-md text-black-600">Do you need blood? </a>
                        <a href="#" style={{ fontFamily: 'inria-serif' }} className="text-md text-blue-600 hover:underline hover:text-blue-800 font-bold" onClick={() => navigate("/")}>Register</a>
                    </div>
                </div>
            </div>
