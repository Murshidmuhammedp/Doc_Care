...
function Footer() {
    return (
        <>
            <div className="bg-gray-300 text-base-content py-10 px-4 md:px-10">
                <footer className="flex flex-col md:flex-row justify-around">
                    <nav className="mb-8 md:mb-0">
                        <h3 className="footer-title font-bold">Services</h3>
                        <a className="link link-hover block mt-2">Branding</a>
                        <a className="link link-hover block mt-2">Design</a>
                        <a className="link link-hover block mt-2">Marketing</a>
                        <a className="link link-hover block mt-2">Advertisement</a>
                    </nav>
                    <nav className="mb-8 md:mb-0">
